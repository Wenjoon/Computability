...
step 1: Go to LimitedRegisterMachine.c

step 2: Go to main function (at the bottom)

step 3: edit the R array to adjust the registers and the I array to adjust the instructions

step 4: recompile the file and run LimitedRegistMachine.exe
